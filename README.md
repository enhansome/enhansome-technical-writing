...
* [Patina](https://github.com/devswha/patina) ⭐ 348 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-07 - Audits and rewrites AI-sounding technical writing while preserving meaning, claims, numbers, polarity, and causation.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 129 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A Claude Code plugin that removes AI writing patterns from text — tricolons, em-dash pileups, hedging stacks, sycophancy openers, stock vocabulary.
...
[Awesome Technical Writing](https://github.com/BolajiAyodeji/awesome-technical-writing) ⭐ 2,297 | 🐛 8 | 📅 2026-07-22 © 2019 by [Bolaji Ayodeji](https://bolajiayodeji.com) is licensed under the [Creative Commons Attribution-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-sa/4.0) license.
