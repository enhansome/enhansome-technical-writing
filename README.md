...
* [Readme Markdown Generator](https://github.com/kefranabg/readme-md-generator) ⭐ 11,130 | 🐛 30 | 🌐 JavaScript | 📅 2022-09-20 - CLI that generates beautiful README.md files.
* [Paid Community Writer Programs](https://github.com/malgamves/CommunityWriterPrograms) ⭐ 4,176 | 🐛 8 | 📅 2026-07-31 - A list of companies that have paid developer community writer programs.
* [Log4brains](https://github.com/thomvaill/log4brains) ⭐ 1,571 | 🐛 57 | 🌐 TypeScript | 📅 2024-12-17 - Docs-as-code knowledge base to manage Architecture Decision Records (ADR) for your project and publish them automatically as a static website.
...
* [Patina](https://github.com/devswha/patina) ⭐ 331 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01 - Audits and rewrites AI-sounding technical writing while preserving meaning, claims, numbers, polarity, and causation.
* [Slopless](https://github.com/seochecks-ai/slopless) ⭐ 321 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-30 - Deterministic textlint preset and CLI to flag AI-generated and padded English prose without calling an LLM.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 123 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - A Claude Code plugin that removes AI writing patterns from text — tricolons, em-dash pileups, hedging stacks, sycophancy openers, stock vocabulary.
